...
// mocha.run();
// x.x.x
var versions = ['1.3.0.9', '11.3.0.11.0-hotfix.3', '0.2.0', '3.3.3.3', '0.2-beta', '3.3.3.3.3', '3.10', '0.2.0'];
var sortVer = versions.sort(function (a, b) {
  var arr1 = a.split('.');
  var arr2 = b.split('.');
  var minLen = Math.min(arr1.length, arr2.length);
  var isArr1LowerVersion = 1;
  var forLoopCount = 0;
  ...
  console.log('sort: ', a, '  ||  ', b, '  result: ', isArr1LowerVersion, "(".concat(forLoopCount, ")"));
